      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="container">
          <div class="video-container" id="video-container">
            ...
            <video controls class="video" id="video" preload="metadata" poster="images/beach.jpeg">
              <source src="video/vacation.mp4" type="video/mp4"></source>
            </video>
        ...
        <svg style="display: none">
          <defs>
            <symbol id="pause" name="pause" viewBox="0 0 24 24">
